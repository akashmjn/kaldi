...
voxceleb1_root=/data/lial/voxceleb/dataset/voxceleb1/
voxceleb2_root=/data/lial/voxceleb/dataset/voxceleb2/
nnet_dir=exp/xvector_nnet_1a
musan_root=/data/lial/voxceleb/dataset/musan/
...
if [ $stage -le 2 ]; then
  ...
  python2.7 steps/data/augment_data_dir.py --utt-suffix "noise" --fg-interval 1 --fg-snrs "15:10:5:0" --fg-noise-dir "data/musan_noise" data/train data/train_noise
  # Augment with musan_music
  python2.7 steps/data/augment_data_dir.py --utt-suffix "music" --bg-snrs "15:10:8:5" --num-bg-noises "1" --bg-noise-dir "data/musan_music" data/train data/train_music
  # Augment with musan_speech
  python2.7 steps/data/augment_data_dir.py --utt-suffix "babble" --bg-snrs "20:17:15:13" --num-bg-noises "3:4:5:6:7" --bg-noise-dir "data/musan_speech" data/train data/train_babble
...
local/nnet3/xvector/run_xvector.sh --stage $stage --train-stage 25 \
